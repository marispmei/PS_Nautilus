...
RUN apt update && DEBIAN_FRONTEND=noninteractive apt install -y ros-noetic-desktop-full ros-noetic-rtabmap-ros
...
RUN DEBIAN_FRONTEND=noninteractive apt install -y python3-rosdep python3-rosinstall python3-rosinstall-generator python3-wstool build-essential
